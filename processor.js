            ...
            if(operandes.addr==null)
            {
                ...
                if(instruction%2==1)//the w bit ==1
                {
                    ...
                    if(v)//the number of iteration is stored in  cx register
                    {
                       ...
                       for(let i=0;i<cx;i++)
                       {
                           this.register.setFlag('C',val&0b1000000000000000);
                            val=val<<1;
                            if(this.register.extractFlag('C'))val=val|0b0000000000000001;
                ...
                }else  //the w bit ==0
                {
                    if(v)//the number of iteration is stored in  cx register
                    {
                       ...
                       for(let i=0;i<cx;i++)
                       {
                        this.register.setFlag('C',val&0b10000000);
                        val=val<<1;
                        if(this.register.extractFlag('C'))val=val|0b00000001;
